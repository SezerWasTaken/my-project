...
$sql = "SELECT ogrenci.ogrno, ogrenci.ograd, ogrenci.ogrsoyad, ogrenci.sinif, not1, not2, perf1, perf2 FROM ogrenci LEFT JOIN matematik ON matematik.ogrno = ogrenci.ogrno ORDER BY ogrenci.ogrno";
$sorgu = $baglan->prepare($sql);
$sorgu->execute();
$notListele = $sorgu->fetchAll(PDO::FETCH_ASSOC);
            ...
            <div class="row mt-4">
                <div class="col">
                    <table class="table table-hover table-dark table-striped">
                        ...
                        <tbody>
                            <?php foreach ($notListele as $satir) { ?>
                                <tr>
                                    <td><?= $satir['ogrno'] ?></td>
                                    <td><?= $satir['ograd'] ?></td>
